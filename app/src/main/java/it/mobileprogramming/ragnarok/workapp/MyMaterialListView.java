...
public class MyMaterialListView extends RecyclerView {
    ...
    public MyMaterialListView(Context context) {
        this(context, null);
    }

    public MyMaterialListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyMaterialListView(Context context, AttributeSet attrs, int defStyle) {
